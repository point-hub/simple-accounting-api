...
import accountingReportBalanceSheetRouter from './modules/accounting-reports/balance-sheet/router';
import accountingReportGeneralLedgerRouter from './modules/accounting-reports/general-ledger/router';
import accountingReportProfitAndLossRouter from './modules/accounting-reports/profit-and-loss/router';
import accountingReportSubledgerRouter from './modules/accounting-reports/subledger/router';
import accountingReportTrialBalanceRouter from './modules/accounting-reports/trial-balance/router';
...
import journalRouter from './modules/journals/router';
...
export default async function (baseRouterInput: IBaseAppInput) {
  ...
  app.use('/v1/journals', await journalRouter(baseRouterInput));
  app.use('/v1/accounting-reports/general-ledger', await accountingReportGeneralLedgerRouter(baseRouterInput));
  app.use('/v1/accounting-reports/subledger', await accountingReportSubledgerRouter(baseRouterInput));
  app.use('/v1/accounting-reports/trial-balance', await accountingReportTrialBalanceRouter(baseRouterInput));
  app.use('/v1/accounting-reports/profit-and-loss', await accountingReportProfitAndLossRouter(baseRouterInput));
  app.use('/v1/accounting-reports/balance-sheet', await accountingReportBalanceSheetRouter(baseRouterInput));
